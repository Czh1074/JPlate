<template>
    ...
    <div class="Messageform">
        ...
        <!-- /商品所属分类 结束 -->
        <h2 style="text-align: center;padding-bottom: 30px;">添加动态信息</h2>
        <el-form ref="trend" :model="trend" label-width="80px" label-position="left">
            <el-form-item label="主题">
                <el-input v-model="trend.project"></el-input>
            </el-form-item>
            <!-- <el-form-item label="兼职地址">
                <el-input v-model="message.address"></el-input>
            </el-form-item> -->
            <el-form-item label="内容">
                <el-input type="textarea" v-model="trend.introduction"></el-input>
            </el-form-item>
            ...
            <el-form-item>
                <el-button type="primary" @click="addTrend">立即创建</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            addTrend() {
                ...
                this.trend.userId = this.loginInfo.id
                trendApi.addTrend(this.trend).then(response => {
                    this.$message({
                        message: '添加成功',
                        type: 'success'
                    });
            ...
            fileUploadSuccess(response) {
                ...
                if (response.success === true) {
                    this.trend.picture1 = response.data.url;
