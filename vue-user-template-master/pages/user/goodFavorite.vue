                        ...
                        <div class="i-box">
                            ...
                            <article class="ml10 mr10 pt20">
                                ...
                                <div>
                                    ...
                                    <div v-for="good in goods" :key="good.id" class="text item">
                                        <router-link :to="'/good/'+good.good.id" :title="good.name" class="c-666"
                                            style="font-size: 15px; text-align: left;">
                                            <div class="box">
                                                <img class="avatar" :src="good.salt" alt="">
                                                <div class="name-box">
                                                    <span class="name">{{good.nickName}}</span>
                                                    <span class="time">{{good.good.gmtCreate}}</span>
                                                </div>
                                                <div class="theme">
    ...
    export default {
        ...
        methods: {
            getMessageFavoritePageList() {
                ...
                favoriteApi.getMessageFavoritePageList(1, 6, this.loginInfo.id, 2).then(response => {
