                                        ...
                                        <div class="c-666" style="font-size: 15px; text-align: left;">
                                            ...
                                            <div class="box" style="color: #666;">
                                                ...
                                                <div class="name-box">
                                                    ...
                                                    <span class="time">{{good.gmtCreate}}</span>
                                                </div>
                                                ...
                                                <div style="margin-left: 100px;">
                                                    <el-button type="danger" icon="el-icon-delete" circle
                                                        @click="deleteGoodById(good.id)"></el-button>
                                                </div>
                                            </div>
                                            <!-- </router-link> -->
                                        </div>
    ...
    export default {
        ...
        methods: {
            getGoodPageList() {
                ...
                releaseApi.getGoodPageList(1, 6, this.loginInfo.id).then(response => {
            ...
            // //设置分页
            gotoPage(page) {
                trendApi.getGoodPageList(page, 6).then(response => {
            ...
            deleteGoodById(tid) {
                console.log(tid);
                releaseApi.deleteGoodById(tid).then(response => {
                    this.getGoodPageList()
                })
            }
