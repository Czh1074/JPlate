                                        ...
                                        <div class="c-666" style="font-size: 15px; text-align: left;">
                                            ...
                                            <div class="box" style="color: #666;">
                                                ...
                                                <div class="name-box">
                                                    ...
                                                    <span class="time">{{message.gmtCreate}}</span>
                                                </div>
                                                <router-link :to="'/message/'+message.id" :title="message.name">
                                                    <div class="theme">
                                                        {{message.name}}
                                                    </div>
                                                </router-link>
                                                <div style="margin-left: 100px;">
                                                    <el-button type="danger" icon="el-icon-delete" circle
                                                        @click="deleteMessageById(message.id)"></el-button>
                                                </div>
                                            </div>
                                            <!-- </router-link> -->
                                        </div>
    ...
    export default {
        ...
        methods: {
            getMessagePageList() {
                ...
                releaseApi.getMessagePageList(1, 6, this.loginInfo.id).then(response => {
            ...
            // //设置分页
            gotoPage(page) {
                trendApi.getMessagePageList(page, 6).then(response => {
            ...
            //删除动态信息
            deleteMessageById(tid) {
                console.log(tid);
                releaseApi.deleteMessageById(tid).then(response => {
                    this.getMessagePageList()
                })
            }
